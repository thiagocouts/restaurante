        ...
        <div class="global-page-container">
            ...
            <div class="small-11 small-centered large-12 columns footer-section">
                ...
                <div class="horario small-5 medium-3 small-offset-1 medium-offset-0 columns">
                    ...
                    <?php
                        $diaSemana = date('w');
                        $horaAgora = strtotime('now'); //hora de agora
                        $segundosInicioDia = strtotime('today'); //segundos desde que o dia começou
                        $hora = $horaAgora - $segundosInicioDia;

                        if($diaSemana >= 1 && $diaSemana <= 6) {
                            if($hora < 41400) { //11:30 reṕresentam 41400 segundos
                                $texto = 'FECHADO';
                            } else {
                                $texto = 'ABERTO';
                            }
                        } elseif($diaSemana == 0) {
                            if($hora > 7200 && $hora < 41400) { //02:00 e 11:30
                                $texto = 'FECHADO';
                            } elseif($hora > 64800) { //18:00
                                $texto = 'FECHADO';
                            }else {
                                $texto = 'ABERTO';
                            }
                    ...
                    <p><span class="horario-aberto"><?=$texto?></span><br>
                    Seg-Sex: 11h30 às 24h<br>
                    Sábado 11h30 às 02h<br>
                    Domingo 11h30 às 18h</p>
                </div>
